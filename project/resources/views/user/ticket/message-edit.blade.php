        ...
        <nav aria-label="breadcrumb">
          <ol class="breadcrumb breadcrumb-style2 mb-0">
            ...
            <li class="breadcrumb-item {{ url()->current() ? 'active' : '' }}">
              <a href="{{ route('user.ticket.message.edit', $message->id)}}">{{__('Edit Message')}}</a>
            </li>
          </ol>
        </nav>
      </div>
      ...
      <div class="row">
          ...
          <div class="col-md-6">
            <div class="card mb-4">
                ...
                <div class="card-body">
                    <form action="{{ route('user.ticket.message.update', $message->id) }}" method="POST" enctype="multipart/form-data">
                        @csrf
