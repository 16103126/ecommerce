...
@section('title', __('Manage Website Language'))
  ...
  <div class="card mb-3">
    ...
    <div class="row">
        <div class="col-md-12">
            <div class="card">
                <div class="container mt-5">
                  <a href="{{ route('admin.frontendlanguage.create') }}" class="btn btn-primary ml-2"><i class='bx bxs-message-square-add'></i>&nbsp;{{__('Add Language')}}</a>
                </div>
                <div class="card-body">
                                ...
                                <td>
                                    <div class="btn-group">
                                        ...
                                        <ul class="dropdown-menu" style="">
                                          ...
                                          <li><a class="dropdown-item" href="{{ route('admin.frontendlanguage.status', ['id1' => $language->id,  'id2' => 1]) }}"">{{__('Set Default')}}</a></li>
                                          @endif
                                        </ul>
                                    </div>
                                </td>
                                <td>
                                    <a href="{{ route('admin.frontendlanguage.edit', $language->id) }}" class="btn btn-sm btn-info"><span class="bx bxs-edit"></span></a>
                                    <a href="{{ route('admin.frontendlanguage.delete', $language->id) }}" class="btn btn-sm btn-danger" id="deleteConfirm"><i class="bx bx-message-square-x"></i></a>
