...
@section('title', __('Add Child Category'))
        ...
        <div class="col-md-6">
                ...
                <div class="card-body">
                  <nav aria-label="breadcrumb">
                    <ol class="breadcrumb breadcrumb-style2 mb-0">
                      ...
                      <li class="breadcrumb-item {{ Request::is('admin/childcategory/create') ? 'active' : '' }}">
                        <a href="{{ route('admin.childcategory.create')}}">{{__('Add Child Category')}}</a>
                      </li>
                    </ol>
                  </nav>
                </div>
            ...
            <div class="card mb-4">
                <div class="card-header d-flex justify-content-center mt-3">
                    <h3 class="d-flex justify-content-center text-primary">{{__('Add ChildCategory')}}</h3>
                </div>
                <div class="card-body">
                    <form action="{{ route('admin.childcategory.store') }}" method="POST" enctype="multipart/form-data">
                        ...
                        <div class="mb-3">
                            ...
                            <input type="text" name="name" class="form-control" id="name" required placeholder="{{__('Enter child category')}}">
                        </div>
