        ...
        <div class="col-md-6">
            <div class="card mb-3">
                <div class="card-body">
                    ...
                    <ol class="breadcrumb breadcrumb-style2 mb-0">
                        ...
                        <a href="{{ route('admin.subcategory.edit', $subcategory->id)}}">{{__('Edit SubCategory')}}</a>
                        </li>
                    </ol>
                    </nav>
                </div>
            ...
            <div class="card mb-4">
                <div class="card-header d-flex justify-content-center mt-3">
                    <h3 class="d-flex justify-content-center text-primary">{{__('Edit SubCategory')}}</h3>
                </div>
                <div class="card-body">
                    <form action="{{ route('admin.subcategory.update', $subcategory->id) }}" method="POST" enctype="multipart/form-data">
                        ...
                        <div class="mb-3">
                            ...
                            <input type="text" name="slug" class="form-control" id="slug" value="{{ $subcategory->slug }}">
                        </div>

                        <div class="mb-3">
                            <label for="formFile" class="form-label">{{__('Image')}}</label>
                            <img src="{{ asset('assets/admin/image/subcategory/'.$subcategory->image) }}" alt="" id="imagePreview" width="100px;">
