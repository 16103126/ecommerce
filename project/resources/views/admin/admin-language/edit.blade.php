...
@section('title', __('Edit Admin Pannel Language'))
    ...
    <div class="row">
        <div class="col-md-12">
                  ...
                  <nav aria-label="breadcrumb">
                    <ol class="breadcrumb breadcrumb-style2 mb-0">
                      ...
                      <li class="breadcrumb-item {{ url()->current() ? 'active' : '' }}">
                        <a href="{{ route('admin.adminlanguage.create')}}">{{__('Edit Language')}}</a>
                      </li>
                    </ol>
                  </nav>
                </div>
            ...
            <div class="card mb-4">
                ...
                <div class="card-body">
                    <form action="{{ route('admin.adminlanguage.update', $language->id) }}" method="POST" enctype="multipart/form-data">
                        @csrf
